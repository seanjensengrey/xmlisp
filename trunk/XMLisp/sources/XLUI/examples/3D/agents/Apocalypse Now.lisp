    ...
    <agent-3d-view name="war" vflex="1">
      <chopper>
        <group pitch="-90" x="-1.0">
          <rotor rotor-speed="360.0" width="5.0" height="0.2" x-turn="2.5" y-turn="0.1" texture="metal2.png"/>
        </group>
        <cube draggable="true" x="1.0" y="-1.3" z="-0.5" texture="metal2.png"/>
        <cylinder x="2.0" y="-0.8" heading="90" base-radius="0.3" top-radius="0.1" depth="2.0" texture="metal2.png"/>

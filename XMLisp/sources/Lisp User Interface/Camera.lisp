...
(defclass CAMERA ()
 ((view :accessor view :initform nil :initarg :view :documentation "view or window")
  (eye-x :accessor eye-x :initform 0.0d0 :type double-float)
  (eye-y :accessor eye-y :initform 0.0d0 :type double-float)
  (eye-z :accessor eye-z :initform 2.0d0 :type double-float)
  (center-x :accessor center-x :initform 0.0d0 :type double-float)
  (center-y :accessor center-y :initform 0.0d0 :type double-float)
  (center-z :accessor center-z :initform 0.0d0 :type double-float)
  (up-x :accessor up-x :initform 0.0d0 :type double-float)
  (up-y :accessor up-y :initform 1.0d0 :type double-float)
  (up-z :accessor up-z :initform 0.0d0 :type double-float)
  (fovy :accessor fovy :initform 60.0d0 :type double-float :documentation "viewing angle")
  (aspect :accessor aspect :initform 1.0d0 :type double-float)
  (near :accessor near :initform 0.005d0 :type double-float)
  (far :accessor far :initform 2000.0d0 :type double-float)
  (azimuth :accessor azimuth :initform 0.0d0 :type double-float)
  (zenith :accessor zenith :initform 0.0d0 :type double-float))
